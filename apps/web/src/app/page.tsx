    ...
    <div className="game-container">
            ...
            <div className="flex items-center gap-4 text-white">
              ...
              <div>
                ...
                <div className="text-sm opacity-75">
                  {profile.tribe === 1 ? 'Romans' :
                    profile.tribe === 2 ? 'Teutons' :
                      profile.tribe === 3 ? 'Gauls' :
                        profile.tribe === 4 ? 'Egyptians' :
                          profile.tribe === 5 ? 'Nubians' : 'Unknown'} Tribe
                </div>
              </div>
            </div>
      ...
      <AuthModal
        ...
        onSuccess={() => {
          ...
          // The useAuth hook will automatically update via onAuthStateChange
        }}
      />
    </div>
  )
